...
# Selection Arrays
selex_array_1 <- omnibus_test(sim_arrays, "res_1_group_2", 0.05)
selex_array_2 <- omnibus_test(sim_arrays, "res_2_group_2", 0.05)
selex_array_3 <- omnibus_test(sim_arrays, "res_3_group_2", 0.05)
...
method_array_2 <- omnires_test(sim_arrays, 2, 0.05)
# method_array_3 <- omnires_test(sim_arrays, 3, 0.05)
# method_array_4 <- omnires_test(sim_arrays, 4, 0.05)
method_array_5 <- omnires_test(sim_arrays, 5, 0.05)
method_array_6 <- omnires_test(sim_arrays, 6, 0.05)
method_array_7 <- omnires_test(sim_arrays, 7, 0.05)
method_array_8 <- omnires_test(sim_arrays, 8, 0.05)
method_array_9 <- omnires_test(sim_arrays, 9, 0.05)
method_array_10 <- omnires_test(sim_arrays, 10, 0.05)
# method_array_11 <- omnires_test(sim_arrays, 11, 0.05)
